...
## CICD Infra setup
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated-infra" (https://github.com/RichieJJ/devops-fully-automated-infra-02)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated-infra" (https://github.com/RichieJJ/devops-fully-automated-infra-02.git) & name it "devops-fully-automated-infra"**
